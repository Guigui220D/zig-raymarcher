...
pub fn get(alloc: std.mem.Allocator) !Scene {
    ...
    scene[1] = .{
        ...
        .object = try Object.initTransform(
            ...
            zlm.vec3(zlm.toRadians(0.0), zlm.toRadians(10.0), 0),
            zlm.Vec3.one,
            zlm.vec3(2, -3, 7),
        ),
    };
    ...
    scene[2] = .{
        ...
        .object = try Object.initTransform(
            ...
            zlm.vec3(zlm.toRadians(10.0), zlm.toRadians(10.0), zlm.toRadians(-10.0)),
            zlm.Vec3.all(6),
            zlm.vec3(0, 2, 3),
        ),
    };
    ...
    lights[0] = .{
        .color = .{ .r = 0, .g = 1, .b = 0 },
        .position = zlm.vec3(1, 1, -1),
    };
    lights[1] = .{
        .color = .{ .r = 1, .g = 0, .b = 1 },
        .position = zlm.vec3(-1.2, 2, -1),
    };
